...
def test_softmax():
    """Test the neatfast.math_utils.softmax function."""
    ...
    for test in test_data:
        results_list = list(neatfast.math_util.softmax(test[0]))
        for a, b in zip(test[1], results_list):
            assert_almost_equal(a, b)

    #softmax_result = list(neatfast.math_util.softmax([1.0, 2.0, 3.0, 4.0, 1.0, 2.0, 3.0]))
